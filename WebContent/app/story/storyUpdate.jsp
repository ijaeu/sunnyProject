   ...
   page="${pageContext.request.contextPath}/app/header/header.jsp"/>  --%>
	<div class="container">
		<form
			...
			<input type = "hidden" name="storyNumber" value="${story.getStoryNumber()}">
			<h1 class="sub-title">
				<span class="story-ico"></span> 스토리 글쓰기 <span class="story-txt">나만의
					볕 들 스토리</span>
			</h1>
			<div class="form-group">
				<input type="text" id="title" name="storyTitle" value="${story.getStoryTitle()}" required
			...
			<div class="storyContent-box">
				<textarea id="summernote" name="storyContent"> <c:out value="${story.getStoryContent()}"></c:out> </textarea>
			...
			<div class="storyContent-box2">
				<textarea id="summernote2" name="storyContent2"><c:out value="${story.getStoryContent2()}"></c:out></textarea>
				<div class="form-group2">
					<div class="image-upload-wrap2">
			...
			<div class="storyContent-box3">
				<textarea id="summernote3" name="storyContent3"><c:out value="${story.getStoryContent3()}"></c:out></textarea>
				<div class="form-group2">
					<div class="image-upload-wrap2">
			...
			<div class="btn-groups">
				<button type="submit" name="action" value="write" class="submit-btn">수정</button>
