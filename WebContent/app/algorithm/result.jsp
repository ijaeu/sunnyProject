...
String plantName = "";
String[] plantContents = new String[4];
String plantImg = "";
...
if (algorithmResult.equals("00000")) {
    ...
    plantName = "드라세나 마지나타";
    plantContents[0] = "드라세나 마지나타는 길게 뻗은 줄기가 매력적인 식물이에요. ";
    plantContents[1] = "줄기에 상처가 나면 빨갛게 수액이 흘러서 용혈수라고도 불려요. 식물엔 문제없으니 걱정마세요! 🙌";
    plantContents[2] = "빛이 부족하면 잎이 노랗게 변하고 떨어져요. 실내에서 키울 땐 적당한 빛이 있어야 한답니다";
    plantContents[3] = "마지나타는 겉 흙이 충분히 말랐을 때 흠뻑 물 주는게 좋아요. 배수가 중요한 식물이니 분갈이 할 땐 흙에 난석을 섞어주는게 좋답니다. ";
    plantImg = "../../assets/img/algorithm/00010.jpg";
} else if (algorithmResult.equals("00011")) {
    plantName = "호야";
    plantContents[0] = "호야는 덩굴성 식물로 나무나 바위에 붙어서 자랄 수 있는 식물이에요. 행잉플랜트로 키울수 있답니다 👍 ";
    plantContents[1] = "직사광선을 싫어해서 반음지에 키우기 적합해요. 무늬의 색상이 핑크색, 흰색, 연두색 등 다양하게 존재해요!";
    plantContents[2] = "물은 흙이 빠삭하게 말랐을 때 흠뻑 주는게 좋아요."; 
    plantContents[3] = "여러 해 키우다 보면 예쁜 꽃도 볼 수 있답니다 🌺";
    plantImg = "../../assets/img/algorithm/00011.jpg";
} else if (algorithmResult.equals("00100")) {
    plantName = "칼라데아 진저";
    plantContents[0] = "칼라데아 진저는 진녹색의 잎에 선명한 분홍색의 빗살무늬가 매력적인 식물이에요!";
    plantContents[1] = "따뜻한 남아메리카가 고향이기 때문에 추위에는 약한 편이고, 촉촉한 공중습도를 좋아해요.";
    plantContents[2] = "가끔 샤워하실 때 화장실로 데려가 스팀을 맞게 해주시면 아주 좋아할거예요.";
    plantContents[3] ="칼라데아 진저는 낮에는 햇빛을 많이 받기 위해 잎을 내려 활짝 펴고 밤에는 다시 하늘 위로 오므리는 변화를 보인답니다. 움직임을 관찰하는 재미가 있는 식물이예요.";
    ...
    plantName = "에크메아 파시아타";
    plantContents[0] = "에크메아 파시아타는 파인애플과 아나나스 종류중 하나에요. ";
    plantContents[1] ="잎에 뽀얀가루가 묻어있는데 가루분이 닦이지 않도록 관리해야 해요.";
    plantContents[2] ="과습에 약해서 겉흙이 빠삭하게 말랐을 때 물 주는게 좋아요!";
    plantContents[3] ="빛을 좋아하지만 직사광선은 싫어해요. 반양지에서 키워 주세요👏";
    plantImg = "../../assets/img/algorithm/00110.jpg";
}else if (algorithmResult.equals("00111")) {
    plantName = "러브체인";
    plantContents[0] = "러브체인은 하트모양의 잔잔한 잎이 매력적인 친구에요. ";
    plantContents[1] ="부부의 금슬이 좋으면 잘 자란다는 속설이 있어요 💖";
    plantContents[2] ="음지에서 키우면 줄기가 가늘어지고 끊어져요. 양지에서 해를 많이 보면 잎이 자주빛으로 물든답니다.";
    plantContents[3] ="러브체인은 알뿌리 식물이라 물을 많이 주면 안돼요! 화분의 흙이 완전히 마르면 물을 주세요 🙌";
    plantImg = "../../assets/img/algorithm/00111.jpg";
}else if (algorithmResult.equals("01000")) {
    plantName = "몬스테라";
    plantContents[0] = "몬스테라는 잎이 자랄 수록 크고 멋스럽게 갈라지는 식물입니다.";
    plantContents[1] ="몬스테라는 빛이 부족하면 성장이 더디고 마디가 길어져 밉게 자랍니다.";
    plantContents[2] ="해를 직접보면 잎이 탈수 있어요! 해가 걸러들어오는 반음지에서 키워 주세요. ";
    plantContents[3] ="겨울철이 되면 생장이 둔화되어 겨울잠을 잔답니다. 물은 2주일에 한 번씩 흠뻑 주시는게 좋아요! 👏";
    ...
    plantName = "루비 고무나무";
    plantContents[0] = "루비 고무나무는 수채화처럼 붉게 물든 잎이 매력적인 식물이에요.";
    plantContents[1] = "고무나무 종류는 초보자도 쉽게 키울 수 있어서 인기도 많답니다! ";
    plantContents[2] = "과습에 예민해서 겉 흙이 바싹 말랐을 때 흠뻑 물주는게 좋아요.👍 분갈이 할 땐 난석을 섞어서 배수층을 만들어 주는걸 추천해요. ";
    plantContents[3] = "어디서든 잘 자라는 편 이지만 적당한 빛을 보는게 좋아요. 빛을 못 보면 색이 옅어진답니다.";
    plantImg = "../../assets/img/algorithm/01010.jpg";
}else if (algorithmResult.equals("01011")) {
    plantName = "알로카시아 아마조니카";
    plantContents[0] = "아마조니카는 알로카시아 종류 중 하나에요. 우리나라에선 거북 알로카시아로도 불려요. ";
    plantContents[1] = "뾰족한 잎모양에 흰 무늬가 매력적인 친구에요. ";
    plantContents[2] ="밝은 곳에 두면 잎이 탈 수 있어요! 반음지에 두고 키우는게 좋답니다.";
    plantContents[3] ="물은 겉 흙이 빠삭하게 말랐을 때 흠뻑 주는게 좋아요!";
    plantImg = "../../assets/img/algorithm/01011.jpg";
}else if (algorithmResult.equals("01100")) {
    plantName = "올리브나무";
    plantContents[0] = "올리브나무는 인테리어용 식물로 급부상하면서 카페에 가면 많이 볼 수 있는 식물이에요. ";
    plantContents[1] ="항상 푸른 잎을 유지하면서 열매도 맺으니 고마운 친구에요!👍";
    plantContents[2] ="빛이 부족하면 웃자라거나 잎이 크게 자란답니다. 물이 부족하면 잎이 동그랗게 말리고 끝이 까맣게 타요.";
    plantContents[3] ="속 흙이 바싹 말랐을 때 충분한 물을 줘야해요. 가지치기는 2~3월에 해주는게 좋아요. 너무 자주하면 열매를 보기 힘들 수 있어요!";
    plantImg = "../../assets/img/algorithm/01100.jpg";
}else if (algorithmResult.equals("01101")) {
    plantName = "유칼립투스";
    plantContents[0] = "유칼립투스는 상쾌한 향이 나서 청량감을 느낄 수 있는 식물이에요. 종류도 700여 종이 넘고 향도 다양해요. ";
    plantContents[1] ="유칼립투스는 햇빛과 바람을 좋아하는 친구에요. 실내에서 키울경우 꼭 바람이 잘 통하는 곳에서 키워야 해요! ";
    plantContents[2] ="건조에 강한 친구지만 물이 부족하면 잎이 고꾸라지고 말라요. 겉 흙이 바싹 말랐을 때 흠뻑 물 주세요.";
    plantContents[3] ="유칼립투스는 배수가 중요해요. 실내에서 카운다면 통기성 좋은 토분에 심는걸 추천드려요! 👍";
    ...
    plantName = "필로덴드론 버킨";
    plantContents[0] = "버킨은 필로덴드론과 식물중 하나로 잎의 흰 무늬가 매력적인 식물이에요. ";
    plantContents[1] = "하얀 무늬는 빛이 부족할 때 초록빛으로 변해요. 적당한 빛을 받고 자라면 오밀조밀 짱짱하게 자란답니다.";
    plantContents[2] = "천남성과 식물로 줄기에서 뿌리가 자랄 수 있어요. 걱정하지 마세요! 잘못된게 아닌 자연스러운 현상이에요! 🙌 ";
    plantContents[3] = "킨은 목 마를 때 줄기부분이 말라요. 겉 흙이 바싹 말랐을 때 흠뻑 주세요.";
    ...
    plantName = "맛상게아나";
    plantContents[0] = "맛상게아나는 옥수수 잎을 닮았다고 Corn plant라고 불리는 식물이에요.";
    plantContents[1] ="병충해에도 강화고 공기정화 능력도 최고에요! 적당한 빛만 있어도 잘 자라는 친구랍니다.👍";
    plantContents[2] ="실내에서 키운다면 과습에 주의해야해요.";
    plantContents[3] ="물은 겉 흙이 바싹 말랐을 때, 흠뻑 주세요. 조금씩 자주 주면 웃자랄 수 있어요!";
    plantImg = "../../assets/img/algorithm/10010.jpg";
}else if (algorithmResult.equals("10011")) {
    plantName = "스파트필름";
    plantContents[0] = "스파트필름은 계절마다 매력적인 흰 꽃이 피는 식물이에요. 생명력이 강해서 처음 식물을 키우는 사람에게 강력 추천하는 식물 1순위랍니다. 👍";
    plantContents[1] = "꽃이 보고 싶다면 꼭 양지에서 키워야하고 빛이 충분하지 않다면 꽃을 피울 힘이 사라져요.";
    plantContents[2] = "스파트필름은 물이 부족할 때 잎이 축 쳐져요. ";
    plantContents[3] = "걱정마세요! 죽은게 아니에요! 🙌 잎이 쳐져있을 때 물을 흠뻑 주면 줄기가 다시 빳빳해진답니다.";
    plantImg = "../../assets/img/algorithm/10011.jpg";
}else if (algorithmResult.equals("10100")) {
    plantName = "필로덴드론 콩고";
    plantContents[0] = "콩고는 크고 무성한 푸른 잎이 매력적인 식물이에요. 생명력이 강해서 초보자에게 강추하는 친구에요 👍";
    plantContents[1] = "콩고는 천남성과라서 가끔 줄기에서 뿌리가 자랄 수 있어요.";
    plantContents[2] = "걱정하지 마세요! 식물에겐 문제 없답니다. 줄기에서 뻗어나온 뿌리가 너무 보기 싫다면? 잘라내주셔도 괜찮아요"; 
    plantContents[3] = "적당한 햇빛을 보는게 좋아요. 물은 겉 흙이 말랐을 때 흠뻑 주세요. 👏";
    ...
    plantName = "스투키";
    plantContents[0] = "스투키는 산세베리아의 한 종류로, 건조한 아프리카 동부가 원산지인 다육식물이에요. ";
    plantContents[1] = "스투키는 해당 형상 이상으로 잘 자라지 못하며 점점 굵기도 가늘어지기도 해요";
    plantContents[2] ="번식욕구 때문인지 계속 키우다 보면 굵은 구근화 뿌리를 옆으로 치솟게 만들어 새싹을 형성해요.";
    plantContents[3] = "참고로 분갈이 때 뿌리에 잔상처가 생기기에 1~2주 정도는 물을 주지 말아야 무난하게 잘 큰답니다👍";
    ...
    plantName = "율마";
    plantContents[0] = "북아메리카가 원산지인 관엽식물이에요";   
    plantContents[1] = "본래는 몬테레이 사이프러스라고 부르는 종을 라임색을 띄는 품종으로 만든 것이에요. ";
    plantContents[2] ="물과 햇빛 및 통풍관리를 소홀히하면 간단하게 시들어버리기 때문에 육성 난이도가 다소 높은 식물이에요.";
    plantContents[3] ="햇빛을 좋아하지만 저온지대를 선호하고, 습기를 유지해줘야 하지만 통풍 역시 잘 되어야 잘 자란답니다.🙌";
    plantImg = "../../assets/img/algorithm/11001.jpg";
}else if (algorithmResult.equals("11010")) {
    plantName = "파키라";
    plantContents[0] = "원산지는 멕시코와 남아메리카 지역이고 주로 실내 공기정화식물로 많이 키워요.👍 ";
    plantContents[1] ="화초 중에서 가장 이국적인 맛을 풍기며 잘 알려지지 않은 사실로, 나무 중에 가장 큰 꽃을 피워요. ";
    plantContents[2] = "뿌리가 매우 부실하고 줄기가 굵은 나무라서 물을 너무 많이 주면 오히려 독이 된다고 해요";
    plantContents[3] = "때문에 화분이 작아야 과습을 피할 수 있답니다.";
    plantImg = "../../assets/img/algorithm/11010.jpg";
}else if (algorithmResult.equals("11011")) {
    plantName = "스킨답서스";
    plantContents[0] = "세계에서 가장 인기 있는 화초로, 대한민국에서는 국민 화초라고 불릴 정도로 많이 키워요. ";
    plantContents[1] ="키우기가 쉬워 입문자에게 좋아요.👍";
    plantContents[2] ="스킨답서스은 습윤한 환경을 필요로 해요.";
   	plantContents[3] ="봄, 여름, 가을에는 화분 토양을 촉촉하게 유지하고 여름에는 스킨답서스에게 매일 물을 주세요. 🙌";
