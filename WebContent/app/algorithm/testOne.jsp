		...
		<div class="answerContainer">
			<form
				...
				<input type="hidden" name="selectOne"> <input type="button"
					class="w-btn-outline w-btn-green2-outline" value="띄엄띄엄"
					onclick="document.getElementsByName('selectOne')[0].value='0';this.form.submit();"></br>
				<input type="button" class="w-btn-outline w-btn-green2-outline" value="자주 줄 수 있어요!"
