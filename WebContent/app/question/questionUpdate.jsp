...
<jsp:include
    ...
    <div class="gosu-question">
      <div class="question-container">
        <!-- form action 작성 -->
        <form action="${pageContext.request.contextPath }/question/questionUpdateOk.qs?questionNumber=${question.getQuestionNumber()}&gosuNumber=${gosuNumber}" id="write-form" method="post" enctype="multipart/form-data">
          <h1 class="title">
          ...
          <div class="question-title">
            <input type="text" id="title" name="questionTitle" value="${question.getQuestionTitle()}" placeholder="* 질문 제목을 입력하세요. " required />
          </div>
          <!-- 질문 내용 -->
          ...
          <div class="Content-box">
            ...
            <div class="summernote-box">
              <textarea id="summernote" name="questionContent"><c:out value="${question.getQuestionContent()}"></c:out></textarea>
            </div>
            <!-- 첨부파일 -->
